...
def _build_silence_analysis(session: dict) -> list:
    ...
    """
    # Define territory map inline — avoids circular import with council
    AGENT_TERRITORIES = {
        'VERA':    ['#AI','#regulation','#biotech','#climate','#research','#academic'],
        'DUKE':    ['#finance','#SEC','#hiring','#M&A','#IPO','#capital','#crypto'],
        'MIRA':    ['#sentiment','#community','#social','#media','#narrative','#AI'],
        'SOL':     ['#patterns','#correlation','#climate','#health','#infrastructure'],
        'NOVA':    ['#infrastructure','#FCC','#permits','#zoning','#spectrum','#energy'],
        'ECHO':    ['#deleted','#wayback','#github','#transparency','#AI','#surveillance'],
        'KAEL':    ['#media','#narrative','#regulation','#AI','#coordination','#PR'],
        'FLUX':    ['#crypto','#commodities','#treasury','#flows','#finance','#macro'],
        ...
        'HERMES':  ['#verification','#facts','#sources'],
    }
