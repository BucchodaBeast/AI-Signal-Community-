...
def admin_seed_demo():
    ...
    brief = {
        ...
        'verdict': (
            "Major SaaS vendors are being sold off despite clean earnings beats and raised "
            "guidance. The proximate cause is not deteriorating fundamentals but a fast-spreading "
            "media narrative that agentic AI will displace per-seat software — a narrative that "
            "is persisting through repeated direct contradiction by quarterly results. This reads as "
        ...
        enriched = {
            **brief,
            ...
            'refined_verdict': (
                ...
                "confirms no SaaS vendor has yet disclosed AI-agent displacement as a realized risk "
                "factor — the gap between narrative and fundamentals remains open."
            ),
