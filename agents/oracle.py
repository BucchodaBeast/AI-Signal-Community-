...
"""
    ...
    def synthesise_from_council(self, session, _retry=0):
        """Take a council session and produce an intelligence brief — with rate limiting."""
...
Do not include any text outside the JSON object. No markdown fences."""
        ...
        try:
            ...
            if resp.status_code == 429:
                self.log.warning("Oracle still rate limited after retries — skipping.")
                return None
            if not resp.ok:
    ...
    def run_on_unprocessed(self, db):
        """Find all unprocessed council sessions and synthesise briefs — with rate limiting."""
